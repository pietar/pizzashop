...
<div id="inhoud" class="container">
  <section id="main" >
      ...
      <div class="kolom">
        <form id="inv_productinfo" method="post" action="ctrl_plaatsen.php?action=insert">  
           <table>
              <tbody>    
                  <tr>
                      <td>Postnr</td>
                  ...
                  <tr>
                      <td>Kostprijs</td>
                      <td> 
                        <input type="number" name="kostprijs" required>
                      </td>
                  </tr>                  
                  <tr>
                      <td>Thuislevering</td>
                      <td> 
                        <input type="number" name="thuis_lev_ok">
                      </td>
                  </tr>                  
                  <tr>
                      <td></td>
